...
namespace Test01 {
    ...
    public partial class Database1DataSet7 : global::System.Data.DataSet {
        ...
        public partial class informationDataTable : global::System.Data.TypedTableBase<informationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public informationRow AddinformationRow(string 学号, string 姓名, string 专业, string 班级, string 活动奖惩) {
...
namespace Test01.Database1DataSet7TableAdapters {
    ...
    public partial class informationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[information] WHERE (([学号] = @Original_学号) AND ([姓名] = @Origina" +
                "l_姓名) AND ([专业] = @Original_专业) AND ([班级] = @Original_班级) AND ((@IsNull_活动奖惩 = 1" +
                " AND [活动奖惩] IS NULL) OR ([活动奖惩] = @Original_活动奖惩)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[information] SET [学号] = @学号, [姓名] = @姓名, [专业] = @专业, [班级] = @班级, [活动奖惩] = @活动奖惩 WHERE (([学号] = @Original_学号) AND ([姓名] = @Original_姓名) AND ([专业] = @Original_专业) AND ([班级] = @Original_班级) AND ((@IsNull_活动奖惩 = 1 AND [活动奖惩] IS NULL) OR ([活动奖惩] = @Original_活动奖惩)));
SELECT 学号, 姓名, 专业, 班级, 活动奖惩 FROM information WHERE (学号 = @学号)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT 学号, 姓名, 专业, 班级, 活动奖惩 FROM dbo.information";
        ...
        public virtual int Fill(Database1DataSet7.informationDataTable dataTable) {
        ...
        public virtual Database1DataSet7.informationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet7.informationDataTable dataTable = new Database1DataSet7.informationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet7.informationDataTable dataTable) {
        ...
        public virtual int Delete(string Original_学号, string Original_姓名, string Original_专业, string Original_班级, string Original_活动奖惩) {
            if ((Original_学号 == null)) {
        ...
        public virtual int Update(string 学号, string 姓名, string 专业, string 班级, string 活动奖惩, string Original_学号, string Original_姓名, string Original_专业, string Original_班级, string Original_活动奖惩) {
            if ((学号 == null)) {
            ...
            if ((Original_活动奖惩 == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_活动奖惩));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string 姓名, string 专业, string 班级, string 活动奖惩, string Original_学号, string Original_姓名, string Original_专业, string Original_班级, string Original_活动奖惩) {
            return this.Update(Original_学号, 姓名, 专业, 班级, 活动奖惩, Original_学号, Original_姓名, Original_专业, Original_班级, Original_活动奖惩);
        }
    }
